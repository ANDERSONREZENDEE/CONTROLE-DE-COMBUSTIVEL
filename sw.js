...
const ARQUIVOS_FIXOS = [
  ...
  './sw.js',
  './base_dados_wm.js',
  './base_dados_wm.js?v=40',
  './base_dados_2_nao_wm.js',
  './base_dados_2_nao_wm.js?v=40',
  './base_senhas.js',
  './base_senhas.js?v=40',
  './LOGOTIPO.jpg',
  './controladoria.jpg',
...
async function responderAtualizavel(evento) {
  ...
  return (
    await caches.match(evento.request, { ignoreSearch: false }) ||
    await caches.match(url.origin + url.pathname, { ignoreSearch: false }) ||
